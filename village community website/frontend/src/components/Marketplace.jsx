...
const Marketplace = () => {
  ...
  const sampleProducts = [
    {
      ...
      price: '\u20b9450/jar',
      image: 'https://www.thaihoney.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/4/_/4_dsc03221.jpg',
    ...
    },
    {
      ...
      price: '\u20b9250/pot',
      image: 'https://i.ytimg.com/vi/IyAO0SRsyc0/maxresdefault.jpg',
    ...
    },
    {
      ...
      category: 'Grains',
      price: '\u20b980/kg',
      image: 'https://png.pngtree.com/thumb_back/fw800/background/20240415/pngtree-grains-and-wheat-ears-from-organic-agriculture-farm-image_15655470.jpg',
    ...
    },
    {
      ...
      category: 'Handicrafts',
      price: '\u20b9300/piece',
      image: 'https://tse3.mm.bing.net/th/id/OIP.vA6Uwkjc6VnpUpJpRXdQ1gHaE7?pid=Api&P=0&h=180',
    ...
    },
    {
      ...
      category: 'Homemade items',
      price: '\u20b9200/jar',
      image: 'https://www.inspiredtaste.net/wp-content/uploads/2023/08/Homemade-Dill-Pickles-4-1200.jpg',
    ...
    },
    {
      ...
      category: 'Homemade items',
      price: '\u20b9120/block',
      image: 'https://5.imimg.com/data5/SELLER/Default/2024/3/404550222/KB/RP/VH/212371716/jaggery-1000x1000.jpg',
    ...
    },
    {
      ...
      category: 'Homemade items',
      price: '\u20b990/200g',
      image: 'https://cdn.shopify.com/s/files/1/1558/1905/products/Superfood_World_Turmeric_Curcumin_Powder_1024x1024.jpg?v=1495982813',
  ...
  const categoryData = [
    { name: 'Grains', image: 'https://c8.alamy.com/comp/WWFJKB/male-farmer-with-heap-of-wheat-grains-in-field-closeup-WWFJKB.jpg' },
    { name: 'Handicrafts', image: 'https://img.freepik.com/premium-photo/use-traditional-handicrafts-such-as-pottery_670382-110219.jpg?w=2000' },
    { name: 'Homemade items', image: 'https://catchymeals.com/wp-content/uploads/2025/08/pickle-recipes-homemade.jpg' },
  ];
