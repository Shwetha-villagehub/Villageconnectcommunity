...
const Marketplace = () => {
  ...
  const sampleProducts = [
    ...
    },
    {
      ...
      category: 'Homemade items',
      price: '\u20b9200/jar',
      image: 'https://images.unsplash.com/photo-1603048719539-9ecb4ae8f394?q=80&w=1200&auto=format&fit=crop',
    ...
    },
    {
      ...
      category: 'Homemade items',
      price: '\u20b990/200g',
      image: 'https://images.unsplash.com/photo-1615485291234-9fbc5341f755?q=80&w=1200&auto=format&fit=crop',
  ...
  const categoryData = [
    { name: 'Grains', image: 'https://images.unsplash.com/photo-1516684732162-798a0062be99?q=80&w=1200&auto=format&fit=crop' },
    { name: 'Handicrafts', image: 'https://images.unsplash.com/photo-1610701596061-2ecf227e85b2?q=80&w=1200&auto=format&fit=crop' },
    { name: 'Homemade items', image: 'https://images.unsplash.com/photo-1603048719539-9ecb4ae8f394?q=80&w=1200&auto=format&fit=crop' },
  ];
